...
const handler = async (m, { conn, args }) => {
   const res = await fetch('https://api.github.com/repos/Sniperghost662009/dylux-fg');
   const json = await res.json();
   let txt = `           *乂  B O T  -  S C R I P T  乂*\n\n`;
      txt += `◦  *Nombre:* ${json?.name || 'TheSnipe-Bot-MD'}\n`;
      ...
      txt += `◦  *Url:* ${json?.html_url || 'https://github.com/Sniperghost662009/Bot-Md'}\n\n`;
